...
You can copy and paste this content into a file named `README.readme` to have all the commands in the same file for easy reference. Adjust the file name if needed.
